...
showCorrelations <- function(corrMatId, corrMatYear, hclustMethod, hclustCut) {
  ...
  cat("\n\n**Left: Correlation Between Regions - Right: Correlation Between Years**\n\n")
  ...
  # prepare last part of figure for a ggplot object
  plot.new()
  ...
  correlationClusterTable |>
    makeTable("Clusters of Regions with High Correlation") |>
    cat("\n\n")
}
